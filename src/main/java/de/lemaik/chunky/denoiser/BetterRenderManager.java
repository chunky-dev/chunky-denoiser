...
public class BetterRenderManager extends RenderManager {
  ...
  public static int ALBEDO_SPP = 15;
  public static int NORMAL_SPP = 15;
            ...
            if (denoiserPath != null) {
              ...
              try {
                ...
                try (PngFileWriter pngWriter = new PngFileWriter(
                    new File(context.getSceneDirectory(),
                        scene.name + "-" + spp + ".denoised.png"))) {
                  pngWriter.write(img.data, img.width, img.height, TaskTracker.Task.NONE);
                }
                System.out.println("hi"+onDenoiseCompleted);
                if (onDenoiseCompleted != null) {
                  onDenoiseCompleted.accept(img);
                }
  ...
  public void setOnDenoiseCompleted(Consumer<BitmapImage> consumer) {
    this.onDenoiseCompleted = consumer;
  }
}
